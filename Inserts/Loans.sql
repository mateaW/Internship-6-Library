...
INSERT INTO Loans (LoanID, BookCopyID, UserID, LoanDate, DueDate, PenaltyRate, Returned, Extended)
VALUES
  (34, 546, 300, '2023-12-05', '2023-12-25', null, false, true),
  (35, 5356, 800, '2023-08-20', '2023-10-19', 0, true, true),
  (36, 45, 150, '2023-09-15', '2023-10-05', null, false, false),
  (37, 56, 920, '2023-10-10', '2023-11-09', 0, true, false),
  (38, 563, 700, '2023-12-25', '2024-01-24', null, false, true),
  (39, 654, 950, '2023-12-05', '2024-02-04', 0, true, true),
  (40, 280, 50, '2023-01-01', '2023-01-21', null, false, false),
  (41, 40, 620, '2023-02-15', '2023-03-07', 2, true, false),
  (42, 342, 300, '2023-03-10', '2023-04-09', null, false, true),
  (43, 435, 900, '2023-04-05', '2023-04-25', 5, true, true),
  (44, 200, 750, '2023-05-20', '2023-07-19', null, false, true),
  (45, 53, 550, '2023-06-12', '2023-07-02', 0, true, false),
  (46, 643, 800, '2023-07-05', '2023-08-04', null, false, true),
  (47, 612, 150, '2023-08-20', '2023-10-19', 4, true, true),
  (48, 4322, 920, '2023-09-15', '2023-10-05', null, false, false),
  (49, 100, 700, '2023-10-10', '2023-11-09', 0, true, false),
  (50, 1800, 950, '2023-11-25', '2024-01-24', null, false, true),
  (51, 3000, 50, '2023-12-05', '2024-02-04', 0, true, true),
  (52, 4500, 620, '2023-01-01', '2023-01-21', null, false, false);
